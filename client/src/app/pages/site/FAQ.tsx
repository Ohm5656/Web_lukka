...
const faqs = [
  ...
  },
  {
    ...
    a: "ได้ครับ ตอนนี้ข้อมูลหน้าร้านถูกรวมอยู่ในหน้า Contact แล้ว เพื่อให้ดูที่อยู่ เวลาเปิดทำการ ข้อมูลการเดินทาง และช่องทางติดต่อได้ครบในหน้าเดียว เหมาะกับคนที่อยากเช็กข้อมูลก่อนแวะมาร้าน",
  },
  {
