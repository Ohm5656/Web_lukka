...
const testimonials = [
  ...
  {
    quote: "หน้าเว็บอ่านง่ายและดูสะอาดดี เวลาเปิดหาข้อมูลต่อก่อนซื้อรู้สึกไม่เหนื่อย เหมือนมีคนคัดของมาให้ดูก่อนแล้ว",
    name: "ธีร์",
    role: "พนักงานออฟฟิศ",
  },
  {
    quote: "ผมชอบที่มีทั้งสินค้าและบทความอยู่ในที่เดียวกัน เวลาอยากเทียบหรือหาข้อมูลเพิ่มมันต่อเนื่องดีมาก",
    name: "ต้นน้ำ",
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-lg text-slate-600">จากคนที่ใช้บริการ TechHaven </p>
            </div>
          </motion.div>
