            ...
            >
              ...
              <div className="mt-6 rounded-[1.5rem] bg-slate-50 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-950">ข้อมูลหน้าร้าน</p>
                    <p className="mt-2 text-sm leading-relaxed text-slate-600">{STORE_INFO.address}</p>
                    <p className="mt-2 text-sm text-slate-500">{STORE_INFO.hours}</p>
                  </div>
                </div>
              </div>
            </motion.div>
