    ...
    <div className="w-full bg-slate-50 py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-slate-950 md:text-5xl">มีคำถามเรื่องสินค้า หรืออยากให้ช่วยแนะนำรุ่นที่เหมาะกับคุณ</h1>
          <p className="mt-5 text-lg leading-relaxed text-slate-600">
            ส่งข้อความหาเราได้เลยครับ ไม่ว่าจะอยากเทียบรุ่น ถามเรื่องการใช้งาน หรือเช็กข้อมูลหน้าร้าน ทีมงานพร้อมช่วยแนะนำแบบคุยง่ายและตอบตรงประเด็น
          </p>
        </motion.div>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:gap-20">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.08 }} className="space-y-8">
            <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
              <h2 className="text-2xl font-bold text-slate-950">ข้อมูลร้าน</h2>
              <div className="mt-8 space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-950">อีเมล</h3>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-200 aspect-[16/10]">
              <img
              ...
              <div className="absolute inset-x-6 bottom-6 rounded-[1.5rem] bg-white/92 p-5 backdrop-blur">
                ...
                <p className="mt-1 text-sm leading-relaxed text-slate-600">
                  ไปที่หน้าร้านและแผนที่เพื่อดูเส้นทาง เวลาเปิดทำการ และข้อมูลการเดินทางแบบรวดเร็วได้เลย
                </p>
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl md:p-10">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-3 text-sm leading-relaxed text-slate-600">
                  ฟอร์มนี้เป็นเดโมฝั่งหน้าเว็บ แต่เราออกแบบให้พร้อมต่อยอดเป็น flow ติดต่อจริงได้ภายหลัง
                </p>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      rows={6}
                      required
                      placeholder="บอกเราได้เลยว่ากำลังมองหาสินค้าแบบไหน ใช้งานประมาณไหน หรืออยากให้ช่วยเทียบรุ่นไหนเป็นพิเศษ"
