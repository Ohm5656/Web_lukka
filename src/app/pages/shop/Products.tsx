      ...
      <div className="container mx-auto px-4 py-10 md:px-6 md:py-12">
        <div className="grid gap-8 lg:grid-cols-[280px_minmax(0,1fr)]">
          <aside className="space-y-6">
            ...
            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
              <h2 className="text-sm font-semibold text-slate-900">ตัวกรองเพิ่มเติม</h2>
              <div className="mt-4 space-y-3 text-sm text-slate-700">
                <label className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3">
                  <span>เฉพาะรุ่นแนะนำ</span>
                  <input type="checkbox" checked={showFeaturedOnly} onChange={(event) => setShowFeaturedOnly(event.target.checked)} />
                </label>
                <label className="flex items-center justify-between rounded-2xl bg-slate-50 px-4 py-3">
                  <span>เฉพาะรุ่นใหม่</span>
            ...
            <div className="rounded-[1.75rem] border border-sky-200 bg-sky-50 p-5 shadow-sm">
              <p className="text-sm font-semibold text-sky-900">ยังไม่แน่ใจว่าจะเริ่มจากอะไรดี?</p>
              <p className="mt-2 text-sm leading-relaxed text-sky-800">ลองอ่านบทความแนะนำก่อนซื้อ หรือแวะไปหน้าร้านเพื่อคุยกับทีมได้เลย</p>
              <div className="mt-4 space-y-2">
                <Button size="sm" asChild className="w-full rounded-xl">
                  <Link to="/articles">อ่านบทความแนะนำ</Link>
                </Button>
                <Button size="sm" asChild variant="outline" className="w-full rounded-xl border-sky-200 bg-white text-sky-900 hover:bg-sky-100">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                <div className="relative w-full lg:max-w-md">
                  ...
                  <input
                    ...
                    placeholder="ค้นหาชื่อสินค้า หรือจุดเด่นที่สนใจ"
              ...
              <div className="mt-16 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm md:p-8">
                <div className="mb-8 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-slate-600">เนื้อหาเหล่านี้จะช่วยให้คุณเข้าใจหมวดสินค้านี้มากขึ้นก่อนเลือกซื้อ</p>
                  </div>
