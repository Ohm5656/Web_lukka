    ...
    <div className="min-h-screen bg-slate-50">
      <section className="relative overflow-hidden bg-slate-950 py-20 text-white md:py-24">
        ...
        <div className="container relative mx-auto px-4 md:px-6">
          <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} className="mx-auto flex max-w-4xl flex-col items-center text-center">
            ...
            <p className="mt-5 text-lg leading-relaxed text-slate-300">
              รวมคู่มือและคำแนะนำที่ช่วยให้เข้าใจได้ง่าย 
            </p>
