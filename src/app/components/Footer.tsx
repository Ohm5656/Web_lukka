    ...
    <footer className="border-t border-neutral-200 bg-neutral-50">
      <div className="container mx-auto px-4 py-14 md:px-6 md:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-relaxed text-neutral-600">
              เว็บขายอุปกรณ์คอมที่ผสานหน้าร้าน บทความความรู้ และ flow การเลือกซื้อไว้ด้วยกันในโทนขาว ดำ แดงที่ดูชัด สะอาด และน่าเชื่อถือ
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-neutral-600">
              ...
              <li><Link to="/store" className="transition-colors hover:text-red-700">หน้าร้านและแผนที่</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-neutral-200 pt-6 text-xs text-neutral-500 md:flex-row md:items-center md:justify-between">
          <p>&copy; {new Date().getFullYear()} {storeName}. ออกแบบเป็นเดโมเว็บไซต์หลายหน้าที่พร้อมต่อยอดเป็นเว็บจริง</p>
          <div className="flex gap-4">
            <a href="#" className="hover:text-neutral-800">นโยบายความเป็นส่วนตัว</a>
            <a href="#" className="hover:text-neutral-800">เงื่อนไขการใช้งาน</a>
          </div>
        </div>
      </div>
    </footer>
